...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   fdf_color_step_bonus.c                             :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: mmaquine <mmaquine@student.42sp.org.br>    +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/10/20 14:58:34 by mmaquine          #+#    #+#             */
/*   Updated: 2025/10/22 20:42:07 by mmaquine         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	*init_color_step(t_point *p_st, t_point *p_end, int *dxdy)
{
	...
	clr->step_b = (double)(get_blue(p_end->color)
			- get_blue(p_st->color)) / dx;
	return (clr);
}
